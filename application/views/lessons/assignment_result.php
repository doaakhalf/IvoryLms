    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-7">
                        <h5 class="header-title my-1"><?php echo get_phrase('submitted_assignment_result'); ?></h5>
                    </div>
                    <div class="col-md-5">
                        <a class="btn btn-outline-primary btn-rounded my-1" href="javascript:;" onclick="load_course_assignments('<?= $course_id; ?>')"> <i class="fas fa-arrow-left"></i> <?php echo get_phrase('back_to_assignment_list'); ?></a>
                    </div>
                </div>
